    ...
    ?>
        <!-- <div class="all"> -->
            ...
            <div class="story">
                <div class="left">
                <h2>Our Story</h2>
                <p>Welcome to Diablo's Kitchen, where culinary excellence meets warm hospitality.
                     Our journey began with a passion for creating exceptional dining experiences, rooted in the rich traditions of gastronomy.</p>
                <p>Driven by a commitment to quality and innovation, we set out to craft a menu that showcases the finest 
                    ingredients and reflects our dedication to culinary artistry. Diablo's Kitchen, a 
                    culinary gem nestled in the heart of Kathmandu, has been enchanting taste buds since its inception in 2000,
                     thanks to the visionary chef Santosh Devkota. With a passion for redefining cuisinea, 
                     Chef Devkota embarked on a culinary journey that would leave an indelible mark on the city's gastronomic scene.
                    <br>
                </p>
                </div>
                <div class="right">
